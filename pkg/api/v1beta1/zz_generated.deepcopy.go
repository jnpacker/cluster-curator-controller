...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HypershiftSpec) DeepCopyInto(out *HypershiftSpec) {
	*out = *in
	...
	if in.HostedClusterSpec != nil {
		...
		*out = new(v1alpha1.HostedClusterSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.NodePools != nil {
		in, out := &in.NodePools, &out.NodePools
		*out = make([]*v1alpha1.NodePoolSpec, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(v1alpha1.NodePoolSpec)
				(*in).DeepCopyInto(*out)
			}
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HypershiftSpec.
func (in *HypershiftSpec) DeepCopy() *HypershiftSpec {
	if in == nil {
		return nil
	}
	out := new(HypershiftSpec)
